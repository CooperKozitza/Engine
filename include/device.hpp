...
namespace eng {
    ...
    public:
        ...
        bool valid() const {
            return physical_device_handle != VK_NULL_HANDLE && logical_device_handle != VK_NULL_HANDLE;
        }

        VkPhysicalDevice get_vulkan_physical_device() const { return physical_device_handle; }
    ...
    private:
        ...
        static result<VkPhysicalDevice> pick_physical_device(instance instance);
